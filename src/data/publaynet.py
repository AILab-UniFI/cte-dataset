...
from src.const import Categories_names
from src.paths import PUB1M
...
def pln_preprocess(annotation_path):
    ...
    pt1m_filenames = {
        f.split("_")[0]: True for f in os.listdir(PUB1M) if os.path.isfile(PUB1M / f)
    }
    
    assert pt1m_filenames, "PUB1M folder / path is empty."
